    ...
    if(fin) {
        ...
        if(app_br) {
            ...
            for(int i=0 ; i<7 ; i++) {
                CLR
                menuUI();
                cout << " Main Menu > Append Branch > error" << endl;
                line();
                cout << "\n\n";
                cout << "                              OOPS !!! " << endl;
...
void edit_strength(){
    ...
    if(fin) {
        ...
        fin.read((char*)&(*cp), sizeof(college));
        int sum = 0;
        for(int i=0 ; i<cp->no_of_branches ; i++) sum = sum + cp->br_strg[i];
        if(sum > strg) {
            CLR
            for(int i=0 ; i<7 ; i++) {
                CLR
                menuUI();
                cout << " Main Menu > Edit Strength > error" << endl;
                line();
                cout << "\n\n";
                cout << "                              OOPS !!! " << endl;
                cout << "            New Strength Less than Already Allocated Strength !!! " << endl;
                cout << "\n\n";
                cout << "      Redirecting to Main Menu in " << 7-i << " s" << endl;
                sleep(1);
            }
